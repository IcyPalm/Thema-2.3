...
public abstract class MeasuringDevice extends Device {
	...
	protected LaserMeasurement detectMeasure;
	protected final ArrayList<LaserMeasurement> scanMeasurements;

	public MeasuringDevice(String name, MobileRobot robot, Position localPos, Environment environment) {
